...
console.log('🔍 ROOT_PATH:', path.resolve(__dirname, '..'));
console.log('🔍 @ alias:', path.resolve(ROOT_PATH, 'src'));
...
module.exports = {
	...
	resolve: {
		...
		alias: {
			...
			'@features': path.resolve(ROOT_PATH, 'src/features'),
			'@widgets': path.resolve(ROOT_PATH, 'src/widgets'),
